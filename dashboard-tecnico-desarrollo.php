...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            <a class="navbar-brand" href="dashboard-tecnico-desarrollo.php">
    ...
    <div class="sidebar">
        <ul class="sidebar-nav">
            <li class="sidebar-nav-item">
                <a href="dashboard-tecnico-desarrollo.php" class="sidebar-nav-link active">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1 class="page-title">Dashboard Técnico - Desarrollo </h1>
