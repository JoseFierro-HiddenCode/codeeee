...
function verDetalleSolicitud(folio) {
    ...
    if (sol.solicita_laptop == 1 || sol.solicita_laptop === true || sol.solicita_laptop === '1') {
        equiposHTML += '<li class="list-group-item">💻 <strong>Laptop</strong></li>';
        tieneEquipos = true;
    }
    
    if (sol.solicita_celular == 1 || sol.solicita_celular === true || sol.solicita_celular === '1') {
        equiposHTML += '<li class="list-group-item">📱 <strong>Celular</strong></li>';
        tieneEquipos = true;
    }
    
    if (sol.solicita_pc == 1 || sol.solicita_pc === true || sol.solicita_pc === '1') {
        equiposHTML += '<li class="list-group-item">🖥️ <strong>PC Escritorio</strong></li>';
        tieneEquipos = true;
    }
    
    if (sol.otros_equipos && sol.otros_equipos.trim() !== '') {
        equiposHTML += `<li class="list-group-item">🗂️ <strong>Otros:</strong> ${sol.otros_equipos}</li>`;
        tieneEquipos = true;
    }
    ...
    // Tab Aprobaciones
    document.getElementById('det-gerente-finanzas').textContent = sol.gerente_finanzas_nombre || '-';
