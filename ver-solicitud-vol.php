...
<div class="d-grid gap-3">
    <!-- Descargar -->
    <?php 
    // Determinar si existe PDF o Word
    $rutaPDF = "../../documents/solicitudes_vol/" . $solicitud['folio'] . ".pdf";
    $rutaDOCX = "../../documents/solicitudes_vol/" . $solicitud['folio'] . ".docx";
    
    if (file_exists($rutaPDF)) {
        $rutaDescarga = $rutaPDF;
        $textoBoton = "Descargar PDF";
        $iconoBoton = "bi-file-pdf";
        $colorBtn = "btn-success";
    } else if (file_exists($rutaDOCX)) {
        $rutaDescarga = $rutaDOCX;
    ...
    <a href="<?= $rutaDescarga ?>" 
       class="btn <?= $colorBtn ?> btn-lg" download>
