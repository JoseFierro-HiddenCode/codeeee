...
<!-- NUEVA SECCIÓN: TONERS / TINTAS -->
<div class="sidebar-section-title">Toners / Tintas</div>
<ul class="sidebar-nav">
    <li class="sidebar-nav-item">
        <a href="toners/solicitar.php" class="sidebar-nav-link">
            <i class="bi bi-cart-plus"></i>
            <span>Solicitar Toners</span>
        </a>
    </li>
    <li class="sidebar-nav-item">
        <a href="toners/mis-solicitudes.php" class="sidebar-nav-link">
            <i class="bi bi-list-ul"></i>
            <span>Mis Solicitudes</span>
        </a>
    </li>
    ...
    <?php if (esJefe()): ?>
    <li class="sidebar-nav-item">
        <a href="toners/aprobar-solicitudes.php" class="sidebar-nav-link">
            <i class="bi bi-check-circle"></i>
            <span>Aprobar Solicitudes</span>
            <?php
            $sqlTonersPendientes = "SELECT COUNT(*) as total FROM solicitudes_toners WHERE jefe_id = ? AND estado = 'pendiente_aprobacion'";
            $tonersPendientes = obtenerUno($sqlTonersPendientes, [$_SESSION['user_id']]);
            if ($tonersPendientes && $tonersPendientes['total'] > 0):
            ?>
                <span class="ms-auto badge bg-warning"><?php echo $tonersPendientes['total']; ?></span>
            <?php endif; ?>
        </a>
    </li>
    <?php endif; ?>
