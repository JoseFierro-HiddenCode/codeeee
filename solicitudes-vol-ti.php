                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions">
                            <div class="d-grid gap-2">
                                ...
                                <?php if ($sol['estado'] == 'pendiente'): ?>
                                    <form method="POST" action="../../actions/accesos/marcar-entregado-vol.php" 
                                          onsubmit="return confirm('¿Confirmar que la solicitud <?= htmlspecialchars($sol['folio']) ?> fue entregada?');">
                                        <input type="hidden" name="historial_id" value="<?= $sol['id'] ?>">
