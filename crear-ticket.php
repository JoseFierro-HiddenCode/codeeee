                        ...
                        <form action="../actions/crear-ticket.php" method="POST" enctype="multipart/form-data" id="formTicket">
                            ...
                            <div class="mb-4" id="categoriaOtroContainer" style="display: none;">
                              ...
                              <!-- NUEVO: Selector de Equipo -->
                                <div class="mb-4">
                                    <label class="form-label">¿A qué equipo va dirigido este ticket? <span class="text-danger">*</span></label>
                                    <div class="border rounded p-3" style="background-color: var(--bg-secondary);">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="radio" name="equipo_asignado" id="equipoSoporte" value="soporte" checked required>
                                            <label class="form-check-label" for="equipoSoporte" style="cursor: pointer;">
                                                <strong>🛠️ Soporte Técnico</strong>
                                                <br>
                                                <small class="text-muted">Problemas de hardware, software, accesos, impresoras, etc.</small>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="equipo_asignado" id="equipoDesarrollo" value="desarrollo" required>
                                            <label class="form-check-label" for="equipoDesarrollo" style="cursor: pointer;">
                                                <strong>💻 Desarrollo</strong>
                                                <br>
                                                <small class="text-muted">Nuevas funcionalidades, reportes, bugs de aplicaciones internas.</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>              
