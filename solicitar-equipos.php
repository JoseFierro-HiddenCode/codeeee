...
// Verificar que sea jefe o usuario autorizado especial
if (!esJefe() && !esUsuarioAutorizadoEspecial()) {
    header('Location: ../dashboard-usuario.php?error=' . urlencode('No tienes permisos para solicitar equipos'));
    exit();
}

// Si es usuario autorizado especial, obtener TODOS los usuarios activos
// Si es jefe normal, obtener solo sus colaboradores
if (esUsuarioAutorizadoEspecial()) {
    ...
    // Es jefe, obtener solo sus colaboradores
    $colaboradores = obtenerColaboradoresDeJefe($_SESSION['user_id']);
}
?>
<!DOCTYPE html>
<html lang="es">
