...
// ============================================
// QUERY PARA KANBAN: TICKETS SIN ASIGNAR
// ============================================
...
ORDER BY 
    ...
    t.created_at DESC
";
$ticketsSinAsignar = obtenerTodos($sqlTicketsSinAsignar);

// Contar tickets sin asignar por estado
...
<!-- ============================================ -->
<!-- KANBAN: TICKETS SIN ASIGNAR -->
<!-- ============================================ -->
<?php if (count($ticketsSinAsignar) > 0): ?>
<div class="card mb-4">
    <div class="card-header" style="background: linear-gradient(135deg, var(--jira-blue) 0%, var(--jira-blue-dark) 100%); color: white; border: none;">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="bi bi-kanban"></i> Tickets Sin Asignar - Vista Kanban
            </h5>
            <small class="opacity-75">
                <i class="bi bi-arrows-move"></i> Arrastra para cambiar estado
            </small>
        </div>
    </div>
    <div class="card-body" style="padding: 24px; background-color: var(--bg-secondary);">
        <div class="kanban-board">
            ...
            <div class="kanban-column" data-status="abierto">
                <div class="kanban-header" style="background-color: #DEEBFF;">
                    <h5 style="color: #0052CC; margin: 0; font-size: 15px; font-weight: 700;">
                ...
                <?php foreach ($ticketsSinAsignar as $ticket): ?>
                    <?php if ($ticket['estado'] == 'abierto'): ?>
                        <div class="kanban-card" data-ticket-id="<?php echo $ticket['id']; ?>" draggable="true">
                            ...
                            <!-- Título del ticket -->
                            <div class="kanban-card-title" onclick="window.location.href='ver-ticket.php?id=<?php echo $ticket['id']; ?>'" style="cursor: pointer;">
                                <?php echo e($ticket['titulo']); ?>
                            </div>
                            
                            <!-- Footer con prioridad y usuario -->
                            <div class="kanban-card-footer">
                                <?php echo badgePrioridad($ticket['prioridad']); ?>
                                <div class="avatar-initials" title="<?php echo e($ticket['usuario_nombre']); ?>">
            ...
            <div class="kanban-column" data-status="en_progreso">
                <div class="kanban-header" style="background-color: #FFF0B3;">
                    <h5 style="color: #974F0C; margin: 0; font-size: 15px; font-weight: 700;">
            ...
            <div class="kanban-column" data-status="cerrado">
                <div class="kanban-header" style="background-color: #E8F5E9;">
                    <h5 style="color: #36B37E; margin: 0; font-size: 15px; font-weight: 700;">
...
<div class="alert alert-info">
    <i class="bi bi-info-circle"></i> No hay tickets sin asignar en este momento.
</div>
<?php endif; ?>
